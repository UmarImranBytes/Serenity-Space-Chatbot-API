...
class SerenitySupport:
    ...
    def analyze_mood_and_tone(self, user_input: str, user_id: str) -> Dict[str, any]:
        ...
        try:
            ...
            detected_moods = [mood for mood, keywords in mood_keywords.items() if any(keyword in user_input.lower() for keyword in keywords)]
            ...
            detected_context = [ctx for ctx, keywords in context_keywords.items() if any(keyword in user_input.lower() for keyword in keywords)]
    ...
    def generate_response(self, user_input: str, user_id: str, age: Optional[int] = None, reason: Optional[str] = None) -> str:
        ...
        try:
            ...
            special_inputs = {
                "mindfulness": {
                    "response": [
                        "Let’s try a guided mindfulness exercise. Close your eyes if comfortable, and focus on your breath for 1 minute. Inhale for 4, exhale for 6. Notice thoughts but let them pass like clouds. Gently return to your breath if your mind wanders."
                    ],
                ...
                "tools": {
                    "response": [
                        "Let’s explore long-term coping tools. Try journaling daily: Write 3 things you’re grateful for and 1 thing you’re proud of. Or use a CBT technique—when a negative thought arises, ask, 'Is this 100% true?' and reframe it. Apps like Headspace or Calm can also help."
                    ],
                ...
                "plan": {
                    "response": [
                        "Let’s create a plan to keep your vibe high! Pick 3 activities that spark joy—like a walk, music, or calling a friend. Schedule one for today and one for tomorrow. Add a daily affirmation, like ‘I’m worthy of joy.’"
                    ],
                    "follow_up": "How’s the plan feeling? Want to tweak it or add a new activity? (Type 'tweak', 'add', or share more.)"
                },
                "resources": {
                    "response": [
                        "Here are some support resources: Text 'HOME' to 741741 (Crisis Text Line) for free 24/7 support in the US. Or explore therapy options at BetterHelp or Talkspace. For local counselors, check Psychology Today’s directory."
                    ],
                    "follow_up": "Would you like more resource details or help finding local support? (Type 'details', 'local', or your thoughts.)"
                },
                "talk": {
                    "response": [
                        "I’m here—what’s on your mind or heart right now? Share as much or as little as feels right, and I’ll listen."
                    ],
                    "follow_up": "Thank you for sharing. Want to keep talking, try a grounding exercise, or explore a joyful idea? (Type 'talk', 'exercise', 'idea', or your thoughts.)"
                },
                "connect": {
                    "response": [
                        "Connecting with others can amplify your joy! Reach out to a friend who gets you, join a fun online community like a hobby group, or plan a hangout with your partner. Small connections keep the good vibes going."
                    ],
                    "follow_up": "Want ideas for finding a community or tips for connecting? (Type 'community', 'reach out', or share more.)"
                },
                "goal": {
                    "response": [
                        "Let’s set a goal to keep this happiness growing. Try a daily gratitude practice: Note 3 things that make you smile. Or plan to try one new activity this week that sparks joy, like a hobby or outing."
                    ],
                    "follow_up": "How does that goal feel? Want to set another or adjust this one? (Type 'another', 'adjust', or your thoughts.)"
                },
                "gratitude": {
                    "response": [
                        "Let’s deepen your joy with gratitude! Write or think of 3 things you’re thankful for today—maybe a person, a moment, or something small. Feel how it warms your heart. Want to make this a daily habit?"
                    ],
                    "follow_up": "How did that feel? Want to try another gratitude exercise or plan a joyful activity? (Type 'gratitude', 'plan', or share more.)"
                },
                "share": {
                    "response": [
                        "I’d love to hear more about what’s making you happy! What’s the best part of this moment or your relationship right now? Share as much as you’d like."
                    ],
                    "follow_up": "Thanks for sharing! Want to keep talking, spread more joy, or plan something fun? (Type 'talk', 'spread', 'plan', or your thoughts.)"
                },
                "creative": {
                    "response": [
                        "Let’s celebrate your happiness creatively! Try journaling about this joyful moment, sketching something that represents your mood, or making a playlist of upbeat songs. What feels inspiring?"
                    ],
